<template>
  <div class="header">
    ...
    <transition name="fade">
      <div class="detail" v-show="detailShow" translate="fade">
...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .header .content-wrapper .title .brand {
    display: inline-block;
    vertical-align: top;
    width: 30px;
    height: 18px;
  ...
  .header .content-wrapper .title .name {
    margin-left: 6px;
    font-size: 16px;
    line-height: 18px;
    font-weight: bold;
  ...
  .header .content-wrapper .support .icon.decrease {
    bg-image('decrease_1')
  }

  .header .content-wrapper .support .icon.discount {
    bg-image('discount_1')
  }

  .header .content-wrapper .support .icon.guarantee {
  bg-image('guarantee_1')
  }

  .header .content-wrapper .support .icon.invoice {
  bg-image('invoice_1')
  }

  .header .content-wrapper .support .icon.special {
  bg-image('special_1')
  }
  ...
  .header .detail .detail-wrapper .detail-main .supprts{
    width: 80%;
    margin: 0 auto;
  }
  .header .detail .detail-wrapper .detail-main .supprts .support-item{
    padding: 0 12px;
    margin-bottom: 12px;
    font-size: 0;
  }
  .header .detail .detail-wrapper .detail-main .supprts .support-item:last-child{
    margin-bottom: 0;
  }
  .header .detail .detail-wrapper .detail-main .supprts .support-item .icon{
    display: inline-block;
    width: 16px;
    height: 16px;
    vertical-align: top;
  ...
  .header .detail .detail-wrapper .detail-main .supprts .support-item .icon.decrease {
  bg-image('decrease_2')
  }

  .header .detail .detail-wrapper .detail-main .supprts .support-item .icon.discount {
  bg-image('discount_2')
  }

  .header .detail .detail-wrapper .detail-main .supprts .support-item .icon.guarantee {
  bg-image('guarantee_2')
  }

  .header .detail .detail-wrapper .detail-main .supprts .support-item .icon.invoice {
  bg-image('invoice_2')
  }

  .header .detail .detail-wrapper .detail-main .supprts .support-item .icon.special {
  bg-image('special_2')
  }
  .header .detail .detail-wrapper .detail-main .supprts .support-item .text{
    line-height: 12px;
    font-size: 12px;
  }
